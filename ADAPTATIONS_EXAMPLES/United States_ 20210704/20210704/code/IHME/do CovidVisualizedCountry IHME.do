...
keep if location_name == "$country_IHME" | ///
        ...
        location_name == "Georgia" & location_id == 533 | ///
...
qui replace `var'XXX = . if provincestate != "$country_IHME"
...
* wait note: qui running commands ...
...
****
* 11 a daily deaths, national, all subnational, reference scenario = S1, smaple state: Washington 

twoway ///
(line DayDeaMeSmA02S01XWA date, sort lwidth(medium) lcolor(cyan)) /// 
(line DayDeaMeSmA02S01XXX date, sort lwidth(medium) lcolor(black)) /// 
...
legend(order(1 "WA" 2 "USA") rows(1) size(small)) ///
subtitle("sample state: Washington", size(small)) 
...
****
* 11 b daily deaths, subnational, most affected, reference scenario = S1, sample state: Washington 
...
****
* 11 d daily death rate, national, all subnational, reference scenario = S1, sample state: Washington 

twoway ///
(line dea_me_sm_rateXWA date, sort lwidth(medium) lcolor(cyan)) /// 
(line dea_me_sm_rateXXX date, sort lwidth(medium) lcolor(black)) /// 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "WA" 2 "USA") rows(1) size(small)) ///
subtitle("sample state: Washington, Daily death rate in 100,000 smoothed", size(small)) 
...
****
* 21 a daily infections, national, all subnational, reference scenario = S1, sample state: Washington 

twoway ///
(line DayINFMeRaA02S01XWA date, sort lwidth(medium) lcolor(cyan)) /// 
(line DayINFMeRaA02S01XXX date, sort lwidth(medium) lcolor(black)) /// 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
...
****
* 21 b daily infections, subnational, most affected, reference scenario = S1, sample state: Washington 
...
twoway ///
(line TotDeaMeSmA02S01XWA date, sort lwidth(medium) lcolor(cyan)) /// 
(line TotDeaMeSmA02S01XXX date, sort lwidth(medium) lcolor(black)) /// 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
...
twoway ///
(line totdea_me_rateXWA date, sort lwidth(medium) lcolor(cyan)) /// 
(line totdea_me_rateXXX date, sort lwidth(medium) lcolor(black)) /// 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
...
twoway ///
(line TotINFMeRaA02S01XWA date, sort lwidth(medium) lcolor(cyan)) /// 
(line TotINFMeRaA02S01XXX date, sort lwidth(medium) lcolor(black)) /// 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
...
twoway ///
(line DayIFRMeRaA02S01XWA date, sort lwidth(medium) lcolor(cyan)) /// 
(line DayIFRMeRaA02S01XXX date, sort lwidth(medium) lcolor(black)) /// 
if DayIFRMeRaA02S01XWA >= 0 ///
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
