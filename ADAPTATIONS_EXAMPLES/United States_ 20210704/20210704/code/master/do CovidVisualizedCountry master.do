...
global country USA // <<-- set here the country of choice - countries without subnational estimates     
                                                                                                         ***************************
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
	
global country_JOHN US
global country_DELP US
global country_IHME United States of America
global country_IMPE United States
global country_LANL US
global country_SRIV United States
																				                                                                                                          ***************************
                                                                                                         ***************************
...
If the first run does not go thru due to directory path clash, edit the contents within " " of the line _70_ or _73_ below, located beneath ****** set path based on local operating system ****** ,,, 
...
if regexm(c(os),"Mac") == 1 {
	global pathCovidVisualizedCountry "/Users/`usrnam'/Downloads/CovidVisualizedCountry-main/20210704/code/" 
}
else if regexm(c(os),"Windows") {
	global pathCovidVisualizedCountry = "C:\Users\\`usrnam'\Downloads\CovidVisualizedCountry-main\20210704\code\"
}
*
