...
As such, their update 2021-09-09_v8. csv is no longer publicly available. 

For use in this code, IMPE estimates for Canada from “2021-09-09_v8.csv” is stored in file "2021-09-09_v8 Canada.csv".
...
import delimited "2021-09-09_v8 Canada.csv", clear varnames(1) // * Wait Note: large file size, takes a while ...
