...
[`CovidVisualizedCountry`]( https://github.com/pourmalek/CovidVisualizedCountry) for the [`GLOBAL`](https://github.com/pourmalek/CovidVisualizedCountry#CovidVisualizedCountry) level and six world [`REGIONS`](https://github.com/pourmalek/CovidVisualizedCountry#-african-region-afr-americas-region-amr-eastern-mediterranean-region-emr-european-region-eur-south-east-asian-region-sear-western-pacific-region-wpr)
