...
#### graph (2) Manitoba - Daily deaths, reference scenarios, 2021 on
...
#### graph (5) Manitoba - Daily cases or infections, reference scenarios, 2021 on
...
#### graph (6b) Manitoba - Daily estimated infections IHME to reported cases JOHN, main scenarios, 2021 on
...
#### graph (7) Hospital-related outcomes, all time
...
#### graph (9) Manitoba - Daily deaths estimated to reported, reference scenarios, 2021 on
...
#### graph (10) Manitoba - Daily cases or infections estimated to reported, reference scenarios, 2021 on
...
#### graph (11) Manitoba - R effective, 3 scenarios, all time, IHME
...
#### graph (12) Manitoba - Daily Infection-outcomes ratios, 3 scenarios, IHME, 2021 on
...
#### graph (12b) Manitoba - Daily infection hospitalization & fatality ratios, 3 scenarios, IHME, 2021 on
...
#### graph (13) Manitoba - Daily mobility, 3 scenarios, all time, IHME
...
#### graph (14) Manitoba - Daily mask use, 3 scenarios, all time, IHME
...
#### graph (15) Manitoba - Percent cumulative vaccinated, 2021 on, IHME
