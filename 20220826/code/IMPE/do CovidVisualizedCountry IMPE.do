...
Maintain Status Quo changed to Central
...
* gen Forecast only DayDeaMeSmA03S01 not found
...
gen DayDeaFOREA03S01 = DayDeaMeRaA03S01
replace DayDeaFOREA03S01 = . if date < td($IMPEepoch)
label var DayDeaFOREA03S01 "Daily Forecasted Deaths Mean smoothed IMPE S1"

gen DayINFFOREA03S01 = DayINFMeRaA03S01
replace DayINFFOREA03S01 = . if date < td($IMPEepoch)
label var DayINFFOREA03S01 "Daily Forecasted infections Mean smoothed IMPE S1"



gen DayDeaFOREA03S03 = DayDeaMeRaA03S03
replace DayDeaFOREA03S03 = . if date < td($IMPEepoch)
label var DayDeaFOREA03S03 "Daily Forecasted Deaths Mean smoothed IMPE S3"

gen DayINFFOREA03S03 = DayINFMeRaA03S03
replace DayINFFOREA03S03 = . if date < td($IMPEepoch)
label var DayINFFOREA03S03 "Daily Forecasted infections Mean smoothed IMPE S3"
...
rename DayDeaFOREA03S02 DayDeaFOREA03S02_raw
...
label var DayDeaFOREA03S02 "Daily deaths mean smooth IMPE S2"
...
label var DayINFMeSmA03S02 "Daily infections mean smooth IMPE S2"
...
label var DayINFFOREA03S02 "Daily infections mean smooth IMPE S2"
...
label var DayDeaLoSmA03S02 "Daily deaths lower smooth IMPE S2"
...
label var DayINFLoSmA03S02 "Daily infections lower smooth IMPE S2"
...
label var DayDeaUpSmA03S02 "Daily deaths upper smooth IMPE S2"
...
rename DayDeaFOREA03S03 DayDeaFOREA03S03_raw

tssmooth ma DayDeaFOREA03S03_window = DayDeaFOREA03S03_raw if DayDeaFOREA03S03_raw >= 0, window(3 1 3)

tssmooth ma DayDeaFOREA03S03 = DayDeaFOREA03S03_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayDeaFOREA03S03 "Daily deaths mean smooth IMPE S3"


tssmooth ma DayINFMeRaA03S03_window = DayINFMeRaA03S03 if DayINFMeRaA03S03 >= 0, window(3 1 3)

tssmooth ma DayINFMeSmA03S03 = DayINFMeRaA03S03_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayINFMeSmA03S03 "Daily infections mean smooth IMPE S3"


rename DayINFFOREA03S03 DayINFFOREA03S03_raw

tssmooth ma DayINFFOREA03S03_window = DayINFFOREA03S03_raw if DayINFFOREA03S03_raw >= 0, window(3 1 3)

tssmooth ma DayINFFOREA03S03 = DayINFFOREA03S03_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayINFFOREA03S03 "Daily infections mean smooth IMPE S3"
...
tssmooth ma DayINFLoRaA03S03_window = DayINFLoRaA03S03 if DayINFLoRaA03S03 >= 0, window(3 1 3)

tssmooth ma DayINFLoSmA03S03 = DayINFLoRaA03S03_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayINFLoSmA03S03 "Daily infections lower smooth IMPE S3"
...
rename DayDeaFOREA03S01 DayDeaFOREA03S01_raw

tssmooth ma DayDeaFOREA03S01_window = DayDeaFOREA03S01_raw if DayDeaFOREA03S01_raw >= 0, window(3 1 3)

tssmooth ma DayDeaFOREA03S01 = DayDeaFOREA03S01_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayDeaFOREA03S01 "Daily deaths mean smooth IMPE S1"


tssmooth ma DayINFMeRaA03S01_window = DayINFMeRaA03S01 if DayINFMeRaA03S01 >= 0, window(3 1 3)

tssmooth ma DayINFMeSmA03S01 = DayINFMeRaA03S01_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayINFMeSmA03S01 "Daily infections mean smooth IMPE S1"


rename DayINFFOREA03S01 DayINFFOREA03S01_raw

tssmooth ma DayINFFOREA03S01_window = DayINFFOREA03S01_raw if DayINFFOREA03S01_raw >= 0, window(3 1 3)

tssmooth ma DayINFFOREA03S01 = DayINFFOREA03S01_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayINFFOREA03S01 "Daily infections mean smooth IMPE S1"


tssmooth ma DayDeaLoRaA03S01_window = DayDeaLoRaA03S01 if DayDeaLoRaA03S01 >= 0, window(3 1 3)

tssmooth ma DayDeaLoSmA03S01 = DayDeaLoRaA03S01_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayDeaLoSmA03S01 "Daily deaths lower smooth IMPE S1"


tssmooth ma DayINFLoRaA03S01_window = DayINFLoRaA03S01 if DayINFLoRaA03S01 >= 0, window(3 1 3)

tssmooth ma DayINFLoSmA03S01 = DayINFLoRaA03S01_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayINFLoSmA03S01 "Daily infections lower smooth IMPE S1"


tssmooth ma DayDeaUpRaA03S01_window = DayDeaUpRaA03S01 if DayDeaUpRaA03S01 >= 0, window(3 1 3)

tssmooth ma DayDeaUpSmA03S01 = DayDeaUpRaA03S01_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayDeaUpSmA03S01 "Daily deaths upper smooth IMPE S1"


tssmooth ma DayINFUpRaA03S01_window = DayINFUpRaA03S01 if DayINFUpRaA03S01 >= 0, window(3 1 3)

tssmooth ma DayINFUpSmA03S01 = DayINFUpRaA03S01_window, weights( 1 2 3 <4> 3 2 1) replace

label var DayINFUpSmA03S01 "Daily infections upper smooth IMPE S1"
