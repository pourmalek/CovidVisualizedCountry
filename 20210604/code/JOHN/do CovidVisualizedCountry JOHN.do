...
graph save "graph 1 a COVID-19 daily deaths, $country, subnational, Johns Hopkins.gph", replace
graph export "graph 1 a COVID-19 daily deaths, $country, subnational, Johns Hopkins.pdf", replace
...
graph save "graph 1 b COVID-19 daily deaths, $country, subnational, most affected, Johns Hopkins.gph", replace
graph export "graph 1 b COVID-19 daily deaths, $country, subnational, most affected, Johns Hopkins.pdf", replace
...
qui graph save "graph 1 c COVID-19 daily deaths, $country, `l', Johns Hopkins.gph", replace
qui graph export "graph 1 c COVID-19 daily deaths, $country, `l', Johns Hopkins.pdf", replace
...
graph save "graph 2 a COVID-19 daily cases, $country, subnational, Johns Hopkins.gph", replace
graph export "graph 2 a COVID-19 daily cases, $country, subnational, Johns Hopkins.pdf", replace
...
graph save "graph 2 b COVID-19 daily cases, $country, subnational, most affected, Johns Hopkins.gph", replace
graph export "graph 2 b COVID-19 daily cases, $country, subnational, most affected, Johns Hopkins.pdf", replace
...
qui graph save "graph 2 c COVID-19 daily cases, $country, `l', Johns Hopkins.gph", replace
qui graph export "graph 2 c COVID-19 daily cases, $country, `l', Johns Hopkins.pdf", replace
...
graph save "graph 3 a COVID-19 total deaths, $country, subnational, Johns Hopkins.gph", replace
graph export "graph 3 a COVID-19 total deaths, $country, subnational, Johns Hopkins.pdf", replace
...
* Alberta (AB), British Columbia (BC), Manitoba (MB), Nova Scotia (NS), Ontario (ON), Quebec (QC), Saskatchewan (SK)
...
graph save "graph 3 b COVID-19 total deaths, $country, subnational, most affected, Johns Hopkins.gph", replace
graph export "graph 3 b COVID-19 total deaths, $country, subnational, most affected, Johns Hopkins.pdf", replace
...
qui graph save "graph 3 c COVID-19 total deaths, $country, `l', Johns Hopkins.gph", replace
qui graph export "graph 3 c COVID-19 total deaths, $country, `l', Johns Hopkins.pdf", replace
...
graph save "graph 4 a COVID-19 total cases, $country, subnational, Johns Hopkins.gph", replace
graph export "graph 4 a COVID-19 total cases, $country, subnational, Johns Hopkins.pdf", replace
...
graph save "graph 4 b COVID-19 total cases, $country, subnational, most affected, Johns Hopkins.gph", replace
graph export "graph 4 b COVID-19 total cases, $country, subnational, most affected, Johns Hopkins.pdf", replace
...
qui graph save "graph 4 c COVID-19 total cases, $country, `l', Johns Hopkins.gph", replace
qui graph export "graph 4 c COVID-19 total cases, $country, `l', Johns Hopkins.pdf", replace
...
graph save "graph 5 a COVID-19 daily CFR, $country, subnational, Johns Hopkins.gph", replace
graph export "graph 5 a COVID-19 daily CFR, $country, subnational, Johns Hopkins.pdf", replace
...
graph save "graph 5 b COVID-19 daily CFR, $country, subnational, most affected, Johns Hopkins.gph", replace
graph export "graph 5 b COVID-19 daily CFR, $country, subnational, most affected, Johns Hopkins.pdf", replace
...
qui graph save "graph 5 c COVID-19 daily CFR, $country, `l', Johns Hopkins.gph", replace
qui graph export "graph 5 c COVID-19 daily CFR, $country, `l', Johns Hopkins.pdf", replace
