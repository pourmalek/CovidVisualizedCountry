...
subtitle("All provinces avilable in DELP", size(small)) 

qui graph save "graph 1 a COVID-19 daily deaths, $country, subnational, DELP.gph", replace
graph export "graph 1 a COVID-19 daily deaths, $country, subnational, DELP.pdf", replace
...
qui graph save "graph 1 b COVID-19 daily deaths, $country, subnational, most affected, DELP.gph", replace
graph export "graph 1 b COVID-19 daily deaths, $country, subnational, most affected, DELP.pdf", replace
...
ytitle(Daily deaths) title("COVID-19 daily deaths, $country, `l', DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui qui graph save "graph 1 c COVID-19 daily deaths, $country, `l', DELP.gph", replace
qui graph export "graph 1 c COVID-19 daily deaths, $country, `l', DELP.pdf", replace
...
qui graph save "graph 2 a COVID-19 daily cases, $country, subnational, DELP.gph", replace
graph export "graph 2 a COVID-19 daily cases, $country, subnational, DELP.pdf", replace
...
qui graph save "graph 2 b COVID-19 daily cases, $country, subnational, most affected, DELP.gph", replace
graph export "graph 2 b COVID-19 daily cases, $country, subnational, most affected, DELP.pdf", replace
...
xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, `l', DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui qui graph save "graph 2 c COVID-19 daily cases, $country, `l', DELP.gph", replace
qui graph export "graph 2 c COVID-19 daily cases, $country, `l', DELP.pdf", replace
...
qui graph save "graph 3 a COVID-19 total deaths, $country, subnational, DELP.gph", replace
graph export "graph 3 a COVID-19 total deaths, $country, subnational, DELP.pdf", replace
...
qui graph save "graph 3 b COVID-19 total deaths, $country, subnational, most affected, DELP.gph", replace
graph export "graph 3 b COVID-19 total deaths, $country, subnational, most affected, DELP.pdf", replace
...
xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths) title("COVID-19 total deaths, $country, `l', DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui qui graph save "graph 3 c COVID-19 total deaths, $country, `l', DELP.gph", replace
qui graph export "graph 3 c COVID-19 total deaths, $country, `l', DELP.pdf", replace
...
qui graph save "graph 4 a COVID-19 total cases, $country, subnational, DELP.gph", replace
graph export "graph 4 a COVID-19 total cases, $country, subnational, DELP.pdf", replace
...
qui graph save "graph 4 b COVID-19 total cases, $country, subnational, most affected, DELP.gph", replace
graph export "graph 4 b COVID-19 total cases, $country, subnational, most affected, DELP.pdf", replace
...
xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases) title("COVID-19 total cases, $country, `l', DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui qui graph save "graph 4 c COVID-19 total cases, $country, `l', DELP.gph", replace
qui graph export "graph 4 c COVID-19 total cases, $country, `l', DELP.pdf", replace
...
, xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "AB" 2 "BC" 3 "MB" 5 "NL" 6 "NS" 7 "ON" 8 "QC" 9 "SK" 10 "CAN") rows(2) size(small)) ///
subtitle("All provinces avilable in DELP", size(small)) 

qui graph save "graph 5 a COVID-19 daily CFR, $country, subnational, DELP.gph", replace
graph export "graph 5 a COVID-19 daily CFR, $country, subnational, DELP.pdf", replace
...
qui graph save "graph 5 b COVID-19 daily CFR, $country, subnational, most affected, DELP.gph", replace
graph export "graph 5 b COVID-19 daily CFR, $country, subnational, most affected, DELP.pdf", replace
...
xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, `l', DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui qui graph save "graph 5 c COVID-19 daily CFR, $country, `l', DELP.gph", replace
qui graph export "graph 5 c COVID-19 daily CFR, $country, `l', DELP.pdf", replace
...
, xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily active cases) title("COVID-19 daily active cases, $country, DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "AB" 2 "BC" 3 "MB" 5 "NL" 6 "NS" 7 "ON" 8 "QC" 9 "SK" 10 "CAN") rows(2) size(small)) ///
subtitle("All provinces avilable in DELP", size(small)) 

qui graph save "graph 6 a COVID-19 daily active cases, $country, subnational, DELP.gph", replace
graph export "graph 6 a COVID-19 daily active cases, $country, subnational, DELP.pdf", replace
...
qui graph save "graph 6 b COVID-19 daily active cases, $country, subnational, most affected, DELP.gph", replace
graph export "graph 6 b COVID-19 daily active cases, $country, subnational, most affected, DELP.pdf", replace
...
xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily active cases) title("COVID-19 daily active cases, $country, `l', DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) 
  	   
qui qui graph save "graph 6 c COVID-19 daily active cases, $country, `l', DELP.gph", replace
qui graph export "graph 6 c COVID-19 daily active cases, $country, `l', DELP.pdf", replace
...
, xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily active hospitalized) title("COVID-19 daily active hospitalized, $country, DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "AB" 2 "BC" 3 "MB" 5 "NL" 6 "NS" 7 "ON" 8 "QC" 9 "SK" 10 "CAN") rows(2) size(small)) ///
subtitle("All provinces avilable in DELP", size(small)) 

qui graph save "graph 7 a COVID-19 daily active hospitalized, $country, subnational, DELP.gph", replace
graph export "graph 7 a COVID-19 daily active hospitalized, $country, subnational, DELP.pdf", replace
...
qui graph save "graph 7 b COVID-19 daily active hospitalized, $country, subnational, most affected, DELP.gph", replace
graph export "graph 7 b COVID-19 daily active hospitalized, $country, subnational, most affected, DELP.pdf", replace
...
xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily active hospitalized) title("COVID-19 daily active hospitalized, $country, `l', DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) 
  	   
qui qui graph save "graph 7 c COVID-19 daily active hospitalized, $country, `l', DELP.gph", replace
qui graph export "graph 7 c COVID-19 daily active hospitalized, $country, `l', DELP.pdf", replace
...
, xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily active ventilated) title("COVID-19 daily active ventilated, $country, DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "AB" 2 "BC" 3 "MB" 5 "NL" 6 "NS" 7 "ON" 8 "QC" 9 "SK" 10 "CAN") rows(2) size(small)) ///
subtitle("All provinces avilable in DELP", size(small)) 

qui graph save "graph 8 a COVID-19 daily active ventilated, $country, subnational, DELP.gph", replace
graph export "graph 8 a COVID-19 daily active ventilated, $country, subnational, DELP.pdf", replace
...
qui graph save "graph 8 b COVID-19 daily active ventilated, $country, subnational, most affected, DELP.gph", replace
graph export "graph 8 b COVID-19 daily active ventilated, $country, subnational, most affected, DELP.pdf", replace
...
xtitle(Date) xlabel(, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily active ventilated) title("COVID-19 daily active ventilated, $country, `l', DELP, single scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) 
  	   
qui qui graph save "graph 8 c COVID-19 daily active ventilated, $country, `l', DELP.gph", replace
qui graph export "graph 8 c COVID-19 daily active ventilated, $country, `l', DELP.pdf", replace
...
qui graph save "graph 9 COVID-19 daily deaths and cases, $country, `l', DELP.gph", replace
graph export "graph 9 COVID-19 daily deaths and cases,  $country, `l', DELP.pdf", replace
