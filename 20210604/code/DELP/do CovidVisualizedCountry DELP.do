...
graph save "graph 1 a COVID-19 daily deaths, $country, subnational, DELP.gph", replace
...
graph save "graph 1 b COVID-19 daily deaths, $country, subnational, most affected, DELP.gph", replace
...
qui graph save "graph 1 c COVID-19 daily deaths, $country, `l', DELP.gph", replace
...
graph save "graph 2 a COVID-19 daily cases, $country, subnational, DELP.gph", replace
...
graph save "graph 2 b COVID-19 daily cases, $country, subnational, most affected, DELP.gph", replace
...
qui graph save "graph 2 c COVID-19 daily cases, $country, `l', DELP.gph", replace
...
graph save "graph 3 a COVID-19 total deaths, $country, subnational, DELP.gph", replace
...
graph save "graph 3 b COVID-19 total deaths, $country, subnational, most affected, DELP.gph", replace
...
qui graph save "graph 3 c COVID-19 total deaths, $country, `l', DELP.gph", replace
...
graph save "graph 4 a COVID-19 total cases, $country, subnational, DELP.gph", replace
...
graph save "graph 4 b COVID-19 total cases, $country, subnational, most affected, DELP.gph", replace
...
qui graph save "graph 4 c COVID-19 total cases, $country, `l', DELP.gph", replace
...
graph save "graph 5 a COVID-19 daily CFR, $country, subnational, DELP.gph", replace
...
graph save "graph 5 b COVID-19 daily CFR, $country, subnational, most affected, DELP.gph", replace
...
qui graph save "graph 5 c COVID-19 daily CFR, $country, `l', DELP.gph", replace
...
graph save "graph 6 a COVID-19 daily active cases, $country, subnational, DELP.gph", replace
...
graph save "graph 6 b COVID-19 daily active cases, $country, subnational, most affected, DELP.gph", replace
...
qui graph save "graph 6 c COVID-19 daily active cases, $country, `l', DELP.gph", replace
...
graph save "graph 7 a COVID-19 daily active hospitalized, $country, subnational, DELP.gph", replace
...
graph save "graph 7 b COVID-19 daily active hospitalized, $country, subnational, most affected, DELP.gph", replace
...
qui graph save "graph 7 c COVID-19 daily active hospitalized, $country, `l', DELP.gph", replace
...
graph save "graph 8 a COVID-19 daily active ventilated, $country, subnational, DELP.gph", replace
...
graph save "graph 8 b COVID-19 daily active ventilated, $country, subnational, most affected, DELP.gph", replace
...
qui graph save "graph 8 c COVID-19 daily active ventilated, $country, `l', DELP.gph", replace
...
graph save "graph 9 COVID-19 daily deaths and cases, $country, `l', DELP.gph", replace
