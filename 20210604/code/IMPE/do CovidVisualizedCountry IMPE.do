...
qui graph save "graph 1 COVID-19 daily deaths, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 1 COVID-19 daily deaths, 6 scenarios, $country, IMPE.pdf", replace
...
qui graph save "graph 2 COVID-19 daily deaths, median scenario, $country, IMPE.gph", replace
qui graph export "graph 2 COVID-19 daily deaths, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 3 COVID-19 total deaths, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 3 COVID-19 total deaths, 6 scenarios, $country, IMPE.pdf", replace
...
qui graph save "graph 4 COVID-19 total deaths, median scenario, $country, IMPE.gph", replace
qui graph export "graph 4 COVID-19 total deaths, median scenario, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "graph 5 COVID-19 daily cases, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 5 COVID-19 daily cases, 6 scenarios, $country, IMPE.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, IMPE, median scenario", size(medium)) legend(off)

qui graph save "graph 6 COVID-19 daily cases, median scenario, $country, IMPE.gph", replace
qui graph export "graph 6 COVID-19 daily cases, median scenario, $country, IMPE.pdf", replace
...
ytitle(Total cases) title("COVID-19 total cases, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "graph 7 COVID-19 total cases, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 7 COVID-19 total cases, 6 scenarios, $country, IMPE.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Total cases) title("COVID-19 total cases, $country, IMPE, median scenario", size(medium)) legend(off)

qui graph save "graph 8 COVID-19 total cases, median scenario, $country, IMPE.gph", replace
qui graph export "graph 8 COVID-19 total cases, median scenario, $country, IMPE.pdf", replace
...
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, IMPE, 6 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
legend(region(lcolor(none))) legend(bexpand) legend(order(1 "S1" 2 "S2" 3 "S3" 4 "S4" 5 "S5" 6 "S6") rows(1))
  	   
qui graph save "graph 9 COVID-19 daily CFR, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 9 COVID-19 daily CFR, 6 scenarios, $country, IMPE.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%9.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, IMPE, median scenario", size(medium)) legend(off)

qui graph save "graph 10 COVID-19 daily CFR, median scenario, $country, IMPE.gph", replace
qui graph export "graph 10 COVID-19 daily CFR, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 11 COVID-19 daily hospital demand, median scenario, $country, IMPE.gph", replace
qui graph export "graph 11 COVID-19 daily hospital demand, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 12 COVID-19 daily hospital demand, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 12 COVID-19 daily hospital demand, 6 scenarios, $country, IMPE.pdf", replace
...
qui graph save "graph 13 COVID-19 daily hospital incidence, median scenario, $country, IMPE.gph", replace
qui graph export "graph 13 COVID-19 daily hospital incidence, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 14 COVID-19 daily hospital incidence, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 14 COVID-19 daily hospital incidence, 6 scenarios, $country, IMPE.pdf", replace
...
qui graph save "graph 15 COVID-19 daily ICU demand, median scenario, $country, IMPE.gph", replace
qui graph export "graph 15 COVID-19 daily ICU demand, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 16 COVID-19 daily ICU demand, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 16 COVID-19 daily ICU demand, 6 scenarios, $country, IMPE.pdf", replace
...
qui graph save "graph 17 COVID-19 daily ICU incidence, median scenario, $country, IMPE.gph", replace
qui graph export "graph 17 COVID-19 daily ICU incidence, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 18 COVID-19 daily ICU incidence, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 18 COVID-19 daily ICU incidence, 6 scenarios, $country, IMPE.pdf", replace
...
qui graph save "graph 19 COVID-19 daily R effective, median scenario, $country, IMPE.gph", replace
qui graph export "graph 19 COVID-19 daily R effective, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 20 COVID-19 daily R effective, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 20 COVID-19 daily R effective, 6 scenarios, $country, IMPE.pdf", replace
...
qui graph save "graph 21 COVID-19 daily R t, median scenario, $country, IMPE.gph", replace
qui graph export "graph 21 COVID-19 daily R t, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 22 COVID-19 daily R t, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 22 COVID-19 daily R t, 6 scenarios, $country, IMPE.pdf", replace
...
qui graph save "graph 23 COVID-19 daily prevalence, median scenario, $country, IMPE.gph", replace
qui graph export "graph 23 COVID-19 daily prevalence, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 24 COVID-19 daily prevalence, 6 scenarios, $country, IMPE.gph", replace
qui graph export "graph 24 COVID-19 daily prevalence, 6 scenarios, $country, IMPE.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases and deaths) title("COVID-19 daily cases and deaths, $country, IMPE", size(medium)) ///
...
qui qui graph save "graph 25 COVID-19 daily deaths and cases $country, IMPE.gph", replace
qui qui graph export "graph 25 COVID-19 daily deaths and cases $country, IMPE.pdf", replace
