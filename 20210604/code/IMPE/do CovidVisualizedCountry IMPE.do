...
graph save "graph 5 COVID-19 daily cases, 6 scenarios, $country, IMPE.gph", replace
graph export "graph 5 COVID-19 daily cases, 6 scenarios, $country, IMPE.pdf", replace
...
graph save "graph 6 COVID-19 daily cases, median scenario, $country, IMPE.gph", replace
graph export "graph 6 COVID-19 daily cases, median scenario, $country, IMPE.pdf", replace
...
graph save "graph 7 COVID-19 total cases, 6 scenarios, $country, IMPE.gph", replace
graph export "graph 7 COVID-19 total cases, 6 scenarios, $country, IMPE.pdf", replace
...
graph save "graph 8 COVID-19 total cases, median scenario, $country, IMPE.gph", replace
graph export "graph 8 COVID-19 total cases, median scenario, $country, IMPE.pdf", replace
...
graph save "graph 9 COVID-19 daily CFR, 6 scenarios, $country, IMPE.gph", replace
graph export "graph 9 COVID-19 daily CFR, 6 scenarios, $country, IMPE.pdf", replace
...
graph save "graph 10 COVID-19 daily CFR, median scenario, $country, IMPE.gph", replace
graph export "graph 10 COVID-19 daily CFR, median scenario, $country, IMPE.pdf", replace
...
qui graph save "graph 25 COVID-19 daily deaths and cases $country, IMPE.gph", replace
qui graph export "graph 25 COVID-19 daily deaths and cases $country, IMPE.pdf", replace
