...
save "Reference Canada.dta", replace
...
use "Reference Canada.dta", clear
merge 1:1 location_name date using "Best Canada.dta"
drop _merge
merge 1:1 location_name date using "Worse Canada.dta"
drop _merge
...
gen loc_grand_name = "Canada"

replace provincestate = " National" if provincestate == "Canada"
...
TotTesMeSmA02S01	DayCasMeRaA02S01	DayCasLoRaA02S01	DayCasUpRaA02S01	total_pop	///
TotCasMeRaA02S01	TotCasUpRaA02S01	TotCasLoRaA02S01	DayDeaMeRaA02S02	DayDeaLoRaA02S02	DayDeaUpRaA02S02	///
TotDeaMeRaA02S02	TotDeaLoRaA02S02	TotDeaUpRaA02S02	DayDeaMeSmA02S02	DayDeaLoSmA02S02	DayDeaUpSmA02S02	///
TotDeaMeSmA02S02	TotDeaLoSmA02S02	TotDeaUpSmA02S02	TotTesMeSmA02S02	DayCasMeRaA02S02	DayCasLoRaA02S02	///
DayCasUpRaA02S02	TotCasMeRaA02S02	TotCasUpRaA02S02	TotCasLoRaA02S02	DayDeaMeRaA02S03	DayDeaLoRaA02S03	///
DayDeaUpRaA02S03	TotDeaMeRaA02S03	TotDeaLoRaA02S03	TotDeaUpRaA02S03	DayDeaMeSmA02S03	DayDeaLoSmA02S03	///
DayDeaUpSmA02S03	TotDeaMeSmA02S03	TotDeaLoSmA02S03	TotDeaUpSmA02S03	TotTesMeSmA02S03	DayCasMeRaA02S03	///
DayCasLoRaA02S03	DayCasUpRaA02S03	TotCasMeRaA02S03	TotCasUpRaA02S03	TotCasLoRaA02S03	///
...
DayCfrMeRaA02S01	DayCfrLoRaA02S01	DayCfrUpRaA02S01	DayCfrMeRaA02S02	DayCfrLoRaA02S02	DayCfrUpRaA02S02	///
DayCfrMeRaA02S03	DayCfrLoRaA02S03	DayCfrUpRaA02S03	DayDeMMeSmA02S01	DayCaMMeRaA02S01	DayCbDMeRaA02S01	DayDMuMeRaA02S01 {
...
graph save "graph 11 a COVID-19 daily deaths, $country, subnational, IHME, reference scenario.gph", replace
graph export "graph 11 a COVID-19 daily deaths, $country, subnational, IHME, reference scenario.pdf", replace
...
ytitle(Daily deaths) title("COVID-19 daily deaths, $country, IHME, reference scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "AB" 2 "BC" 3 "MB" 4 "ON" 5 "QC") rows(1) size(small)) ///
subtitle("5 most affected provinces", size(small)) 

graph save "graph 11 b COVID-19 daily deaths, $country, subnational, most affected, IHME, reference scenario.gph", replace
graph export "graph 11 b COVID-19 daily deaths, $country, subnational, most affected, IHME, reference scenario.pdf", replace
...
qui graph save "graph 11 c COVID-19 daily deaths, $country, `l', IHME, reference scenario.gph", replace
qui graph export "graph 11 c COVID-19 daily deaths, $country, `l', IHME, reference scenario.pdf", replace
...
qui graph save "graph 12 COVID-19 daily deaths, $country, `l', IHME, reference scenario.gph", replace
qui graph export "graph 12 COVID-19 daily deaths, $country, `l', IHME, reference scenario.pdf", replace
...
qui graph save "graph 13 COVID-19 daily deaths, $country, `l', IHME, best scenario.gph", replace
qui graph export "graph 13 COVID-19 daily deaths, $country, `l', IHME, best scenario.pdf", replace
...
*****************
* 4 daily deaths, national, subnational, separate, worse scenario = S3
...
qui graph save "graph 4 COVID-19 daily deaths, $country, `l', IHME, worse scenario.gph", replace
qui graph export "graph 4 COVID-19 daily deaths, $country, `l', IHME, worse scenario.pdf", replace
...
*****************
* daily cases, reference scenario = S1  (graph numbers starting with 21)


****
* 21 a daily cases, national, all subnational, reference scenario = S1 

twoway ///
(line DayCasMeRaA02S01XAB date, sort lwidth(medium) lcolor(cyan)) /// 1 "AB" cyan
(line DayCasMeRaA02S01XBC date, sort lwidth(medium) lcolor(blue)) /// 2 "BC" blue
(line DayCasMeRaA02S01XMB date, sort lwidth(medium) lcolor(lime)) /// 3 "MB" lime
(line DayCasMeRaA02S01XNS date, sort lwidth(medium) lcolor(magenta)) /// 4 "NS" magenta
(line DayCasMeRaA02S01XNL date, sort lwidth(medium) lcolor(gray)) /// 5 "NL"
(line DayCasMeRaA02S01XNS date, sort lwidth(medium) lcolor(magenta)) /// 6 "NS" magenta
(line DayCasMeRaA02S01XON date, sort lwidth(medium) lcolor(red)) /// 7 "ON" red
(line DayCasMeRaA02S01XQC date, sort lwidth(medium) lcolor(black)) /// 8 "QC" black
(line DayCasMeRaA02S01XSK date, sort lwidth(medium) lcolor(orange)) /// 9 "SK" orange
(line DayCasMeRaA02S01XXX date, sort lwidth(thick) lcolor(gray)) /// 10 "CAN" 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
...
graph save "graph 21 a COVID-19 daily cases, $country, subnational, IHME, reference scenario.gph", replace
graph export "graph 21 a COVID-19 daily cases, $country, subnational, IHME, reference scenario.pdf", replace




****
* 21 b daily cases, subnational, most affected, reference scenario = S1 
* Alberta (AB), British Columbia (BC), Manitoba (MB), Ontario (ON), Quebec (QC)
...
(line DayCasMeRaA02S01XBC date, sort lwidth(medium) lcolor(blue)) /// 2 "BC" blue
(line DayCasMeRaA02S01XMB date, sort lwidth(medium) lcolor(lime)) /// 3 "MB" lime
(line DayCasMeRaA02S01XON date, sort lwidth(medium) lcolor(red)) /// 4 "ON" red
(line DayCasMeRaA02S01XQC date, sort lwidth(medium) lcolor(black)) /// 5 "QC" black
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, IHME, reference scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
graph save "graph 21 b COVID-19 daily cases, $country, subnational, most affected, IHME, reference scenario.gph", replace
graph export "graph 21 b COVID-19 daily cases, $country, subnational, most affected, IHME, reference scenario.pdf", replace




****
* 21 c daily cases, national, subnational, separate, reference scenario = S1 

levelsof provincestate, local(levels)

foreach l of local levels {

twoway (rarea DayCasLoRaA02S01 DayCasUpRaA02S01 date, sort color(green*.2)) ///
(line DayCasMeRaA02S01 date, sort lcolor(green)) ///
if provincestate == "`l'" & DayCasMeRaA02S01 != ., legend(off) ///	   
xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, `l', IHME, reference scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui graph save "graph 21 c COVID-19 daily cases, $country, `l', IHME, reference scenario.gph", replace
qui graph export "graph 21 c COVID-19 daily cases, $country, `l', IHME, reference scenario.pdf", replace
...
****
* 22 daily cases, national, subnational, separate, 3 scenarios 
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, `l', IHME, 3 scenarios", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "S1" 2 "S2" 3 "S3") rows(1))

qui graph save "graph 22 COVID-19 daily cases, $country, `l', IHME, reference scenario.gph", replace
qui graph export "graph 22 COVID-19 daily cases, $country, `l', IHME, reference scenario.pdf", replace
...
*****************
* 23 daily cases, national, subnational, separate, best scenario = S2

levelsof provincestate, local(levels)

foreach l of local levels {

twoway (rarea DayCasLoRaA02S02 DayCasUpRaA02S02 date, sort color(green*.2)) ///
(line DayCasMeRaA02S02 date, sort lcolor(green)) ///
if provincestate == "`l'" & DayCasMeRaA02S01 != ., legend(off) ///	   
xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, `l', IHME, best scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui graph save "graph 23 COVID-19 daily cases, $country, `l', IHME, best scenario.gph", replace
qui graph export "graph 23 COVID-19 daily cases, $country, `l', IHME, best scenario.pdf", replace
...
*****************
* 24 daily cases, national, subnational, separate, worse scenario = S3

levelsof provincestate, local(levels)

foreach l of local levels {

twoway (rarea DayCasLoRaA02S03 DayCasUpRaA02S03 date, sort color(green*.2)) ///
(line DayCasMeRaA02S03 date, sort lcolor(green)) ///
if provincestate == "`l'" & DayCasMeRaA02S01 != ., legend(off) ///	   
xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, `l', IHME, worse scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui graph save "graph 24 COVID-19 daily cases, $country, `l', IHME, worse scenario.gph", replace
qui graph export "graph 24 COVID-19 daily cases, $country, `l', IHME, worse scenario.pdf", replace
...
graph save "graph 31 a COVID-19 total deaths, $country, subnational, IHME, reference scenario.gph", replace
graph export "graph 31 a COVID-19 total deaths, $country, subnational, IHME, reference scenario.pdf", replace
...
graph save "graph 31 b COVID-19 total deaths, $country, subnational, most affected, IHME, reference scenario.gph", replace
graph export "graph 31 b COVID-19 total deaths, $country, subnational, most affected, IHME, reference scenario.pdf", replace
...
qui graph save "graph 31 c COVID-19 total deaths, $country, `l', IHME, reference scenario.gph", replace
qui graph export "graph 31 c COVID-19 total deaths, $country, `l', IHME, reference scenario.pdf", replace
...
qui graph save "graph 32 COVID-19 total deaths, $country, `l', IHME, reference scenario.gph", replace
qui graph export "graph 32 COVID-19 total deaths, $country, `l', IHME, reference scenario.pdf", replace
...
qui graph save "graph 33 COVID-19 total deaths, $country, `l', IHME, best scenario.gph", replace
qui graph export "graph 33 COVID-19 total deaths, $country, `l', IHME, best scenario.pdf", replace
...
qui graph save "graph 34 COVID-19 total deaths, $country, `l', IHME, worse scenario.gph", replace
qui graph export "graph 34 COVID-19 total deaths, $country, `l', IHME, worse scenario.pdf", replace
...
*****************
* total cases, reference scenario = S1  (graph numbers starting with 41)


****
* 41 a total cases, national, all subnational, reference scenario = S1 

twoway ///
(line TotCasMeRaA02S01XAB date, sort lwidth(medium) lcolor(cyan)) /// 1 "AB" cyan
(line TotCasMeRaA02S01XBC date, sort lwidth(medium) lcolor(blue)) /// 2 "BC" blue
(line TotCasMeRaA02S01XMB date, sort lwidth(medium) lcolor(lime)) /// 3 "MB" lime
(line TotCasMeRaA02S01XNS date, sort lwidth(medium) lcolor(magenta)) /// 4 "NS" magenta
(line TotCasMeRaA02S01XNL date, sort lwidth(medium) lcolor(gray)) /// 5 "NL"
(line TotCasMeRaA02S01XNS date, sort lwidth(medium) lcolor(magenta)) /// 6 "NS" magenta
(line TotCasMeRaA02S01XON date, sort lwidth(medium) lcolor(red)) /// 7 "ON" red
(line TotCasMeRaA02S01XQC date, sort lwidth(medium) lcolor(black)) /// 8 "QC" black
(line TotCasMeRaA02S01XSK date, sort lwidth(medium) lcolor(orange)) /// 9 "SK" orange
(line TotCasMeRaA02S01XXX date, sort lwidth(thick) lcolor(gray)) /// 10 "CAN" 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Total cases) title("COVID-19 total cases, $country, IHME, reference scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "AB" 2 "BC" 3 "MB" 5 "NL" 6 "NS" 7 "ON" 8 "QC" 9 "SK" 10 "CAN") rows(2) size(small)) ///
subtitle("All provinces avilable in IHME", size(small)) 

graph save "graph 41 a COVID-19 total cases, $country, subnational, IHME, reference scenario.gph", replace
graph export "graph 41 a COVID-19 total cases, $country, subnational, IHME, reference scenario.pdf", replace




****
* 41 b total cases, subnational, most affected, reference scenario = S1 
* Alberta (AB), British Columbia (BC), Manitoba (MB), Ontario (ON), Quebec (QC)
...
(line TotCasMeRaA02S01XBC date, sort lwidth(medium) lcolor(blue)) /// 2 "BC" blue
(line TotCasMeRaA02S01XMB date, sort lwidth(medium) lcolor(lime)) /// 3 "MB" lime
(line TotCasMeRaA02S01XON date, sort lwidth(medium) lcolor(red)) /// 4 "ON" red
(line TotCasMeRaA02S01XQC date, sort lwidth(medium) lcolor(black)) /// 5 "QC" black
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Total cases) title("COVID-19 total cases, $country, IHME, reference scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
graph save "graph 41 b COVID-19 total cases, $country, subnational, most affected, IHME, reference scenario.gph", replace
graph export "graph 41 b COVID-19 total cases, $country, subnational, most affected, IHME, reference scenario.pdf", replace




****
* 41 c total cases, national, subnational, separate, reference scenario = S1 

levelsof provincestate, local(levels)

foreach l of local levels {

twoway (rarea TotCasLoRaA02S01 TotCasUpRaA02S01 date, sort color(green*.2)) ///
(line TotCasMeRaA02S01 date, sort lcolor(green)) ///
if provincestate == "`l'" & TotCasMeRaA02S01 != ., legend(off) ///	   
xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total cases) title("COVID-19 total cases, $country, `l', IHME, reference scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("with confidence limits", size(small))	
  	   
qui graph save "graph 41 c COVID-19 total cases, $country, `l', IHME, reference scenario.gph", replace
qui graph export "graph 41 c COVID-19 total cases, $country, `l', IHME, reference scenario.pdf", replace
...
*****************
* daily CFR, reference scenario = S1  (graph numbers starting with 51)


****
* 51 a daily CFR, national, all subnational, reference scenario = S1 

twoway ///
(line DayCfrMeRaA02S01XAB date, sort lwidth(medium) lcolor(cyan)) /// 1 "AB" cyan
(line DayCfrMeRaA02S01XBC date, sort lwidth(medium) lcolor(blue)) /// 2 "BC" blue
(line DayCfrMeRaA02S01XMB date, sort lwidth(medium) lcolor(lime)) /// 3 "MB" lime
(line DayCfrMeRaA02S01XNS date, sort lwidth(medium) lcolor(magenta)) /// 4 "NS" magenta
(line DayCfrMeRaA02S01XNL date, sort lwidth(medium) lcolor(gray)) /// 5 "NL"
(line DayCfrMeRaA02S01XNS date, sort lwidth(medium) lcolor(magenta)) /// 6 "NS" magenta
(line DayCfrMeRaA02S01XON date, sort lwidth(medium) lcolor(red)) /// 7 "ON" red
(line DayCfrMeRaA02S01XQC date, sort lwidth(medium) lcolor(black)) /// 8 "QC" black
(line DayCfrMeRaA02S01XSK date, sort lwidth(medium) lcolor(orange)) /// 9 "SK" orange
(line DayCfrMeRaA02S01XXX date, sort lwidth(thick) lcolor(gray)) /// 10 "CAN" 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "AB" 2 "BC" 3 "MB" 5 "NL" 6 "NS" 7 "ON" 8 "QC" 9 "SK" 10 "CAN") rows(2) size(small)) ///
subtitle("All provinces avilable in IHME", size(small)) 

graph save "graph 51 a COVID-19 daily CFR, $country, subnational, IHME, reference scenario.gph", replace
graph export "graph 51 a COVID-19 daily CFR, $country, subnational, IHME, reference scenario.pdf", replace




****
* 51 b daily CFR, subnational, most affected, reference scenario = S1 
* Alberta (AB), British Columbia (BC), Manitoba (MB), Ontario (ON), Quebec (QC)
...
(line DayCfrMeRaA02S01XBC date, sort lwidth(medium) lcolor(blue)) /// 2 "BC" blue
(line DayCfrMeRaA02S01XMB date, sort lwidth(medium) lcolor(lime)) /// 3 "MB" lime
(line DayCfrMeRaA02S01XON date, sort lwidth(medium) lcolor(red)) /// 4 "ON" red
(line DayCfrMeRaA02S01XQC date, sort lwidth(medium) lcolor(black)) /// 5 "QC" black
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
graph save "graph 51 b COVID-19 daily CFR, $country, subnational, most affected, IHME, reference scenario.gph", replace
graph export "graph 51 b COVID-19 daily CFR, $country, subnational, most affected, IHME, reference scenario.pdf", replace




****
* 51 c daily CFR, national, subnational, separate, 3 scenarios
...
if provincestate == "`l'" & DayCfrMeRaA02S01 != ., legend(off) ///	   
xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, `l', IHME, 3 scenarios", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "S1" 2 "S2" 3 "S3") rows(1))
  	   
qui graph save "graph 51 c COVID-19 daily CFR, $country, `l', IHME, 3 scenarios.gph", replace
qui graph export "graph 51 c COVID-19 daily CFR, $country, `l', IHME, 3 scenarios.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily beds needed) title("COVID-19 daily beds needed, $country, `l', IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off)	

graph save "graph 61 COVID-19 daily beds needed, $country, `l', IHME, reference scenario", replace
graph export "graph 61 COVID-19 daily beds needed, $country, `l', IHME, reference scenario.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily beds needed) title("COVID-19 ICU beds needed, $country, `l', IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off)	

graph save "graph 62 COVID-19 daily beds needed, $country, `l', IHME, reference scenario", replace
graph export "graph 62 COVID-19 daily beds needed, $country, `l', IHME, reference scenario.pdf", replace
...
******
* 63 daily nvasive ventilation needed, only in S1
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily beds needed) title("COVID-19 invasive ventilation needed, $country, `l', IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off)	

graph save "graph 63 COVID-19 daily invasive ventilation needed, $country, `l', IHME, reference scenario", replace
graph export "graph 63 COVID-19 daily invasive ventilation needed, $country, `l', IHME, reference scenario".pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily hospital admissions) title("COVID-19 daily hospital admissions, $country, `l', IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off)	
	   
graph save "graph 64 COVID-19 daily hospital admissions, $country, `l', IHME, reference scenario.gph", replace
graph export "graph 64 COVID-19 daily hospital admissions, $country, `l', IHME, reference scenario.pdf", replace
...
* 65 daily hospital admissions, only in S1
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily hospital admissions) title("COVID-19 daily new people going to ICU, $country, `l', IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off)	
	   
graph save "graph 65 COVID-19 daily new people going to ICU, $country, `l', IHME, reference scenario.gph", replace
graph export "graph 65 COVID-19 daily new people going to ICU, $country, `l', IHME, reference scenario.pdf", replace
...
* 66 daily new people going to ICU
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily new people going to ICU) title("COVID-19 daily new people to ICU $country, `l', IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(off)	

graph save "graph 66 COVID-19 daily new people going to ICU, $country, `l', IHME, reference scenario.gph", replace
graph export "graph 66 COVID-19 daily new people going to ICU, $country, `l', IHME, reference scenario.pdf", replace
...
ytitle(Total tests) title("COVID-19 total tests, $country, `l', IHME, 3 scenarios", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "S1" 2 "S2" 3 "S3") rows(1))

graph save "graph 67 COVID-19 total tests, $country, `l', 3 scenarios, IHME.gph", replace
graph export "graph 67 COVID-19 total tests, $country, `l', 3 scenarios, IHME.pdf", replace
...
* 68 daily hospital-related outcomes
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily outcomes) title("COVID-19 daily hospital-related outcomes, $country, `l', IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "Bed" 2 "ICU" 3 "Adm" 4 "ICU new") rows(2))

graph save "graph 68 COVID-19 daily hospital-related outcomes, $country, `l', reference scenario, IHME.gph", replace
graph export "graph 68 COVID-19 daily hospital-related outcomes, $country, `l', reference scenario, IHME.pdf", replace
...
* 69 daily hospital-related outcomes, wo beds needed 
...
graph save "graph 69 COVID-19 daily hospital-related outcomes, $country, `l', reference scenario, IHME, wo beds needed.gph", replace
graph export "graph 69 COVID-19 daily hospital-related outcomes, $country, `l', reference scenario, IHME, wo beds needed.pdf", replace
...
ytitle(Daily deaths per 100k rate) title("COVID-19 daily deaths raw per 100k rate, $country, `l', IHME", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "Mean" 2 "Lower" 3 "Upper") rows(1))

graph save "graph 70 COVID-19 daily deaths raw per 100k rate, $country, `l',, IHME.gph", replace
graph export "graph 70 COVID-19 daily deaths raw per 100k rate, $country, `l',, IHME.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily deaths per 100k rate) title("COVID-19 daily deaths smoothed per 100k rate, $country, `l', IHME", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "Mean" 2 "Lower" 3 "Upper") rows(1))

graph save "graph 71 COVID-19 daily deaths smoothed per 100k rate, $country, `l', IHME.gph", replace
graph export "graph 71 COVID-19 daily deaths smoothed per 100k rate, $country, `l', IHME.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths per 100k rate) title("COVID-19 total deaths raw per 100k rate, $country, `l', IHME", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "Mean" 2 "Lower" 3 "Upper") rows(1))

graph save "graph 72 COVID-19 total deaths raw per 100k rate, $country, `l', IHME.gph", replace
graph export "graph 72 COVID-19 total deaths raw per 100k rate, $country, `l', IHME.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Total deaths per 100k rate) title("COVID-19 total deaths smoothed per 100k rate, $country, `l', IHME", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "Mean" 2 "Lower" 3 "Upper") rows(1))

graph save "graph 73 COVID-19 total deaths smoothed per 100k rate, $country, `l', IHME.gph", replace
graph export "graph 73 COVID-19 total deaths smoothed per 100k rate, $country, `l', IHME.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Estimated infections per 100k rate) title("COVID-19 estimated infections per 100k rate, $country, `l', IHME", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(order(1 "Mean" 2 "Lower" 3 "Upper") rows(1))

graph save "graph 74 COVID-19 estimated infections per 100k rate, $country, `l', IHME.gph", replace
graph export "graph 74 COVID-19 estimated infections per 100k rate, $country, `l', IHME.pdf", replace
...
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Confirmed infections per 100k rate) title("COVID-19 confirmed infections per 100k rate, $country, `l', IHME", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
legend(off)

graph save "graph 75 COVID-19 confirmed per 100k rate, $country, `l', IHME.gph", replace
graph export "graph 75 COVID-19 confirmed per 100k rate, $country, `l', IHME.pdf", replace
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small)) ylabel(, labsize(small) angle(horizontal)) ///
ytitle(Daily cases and deaths) title("COVID-19 daily cases and deaths, $country, `l', IHME", size(small)) ///
...
graph save "graph 76 COVID-19 daily deaths and cases $country, `l', IHME.gph", replace
qui graph export "graph 76 COVID-19 daily deaths and cases $country, `l', IHME.pdf", replace
