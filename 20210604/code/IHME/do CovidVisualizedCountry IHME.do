...
subtitle("Reference scenario, all provinces avilable in IHME", size(small)) 
...
subtitle("Reference scenario, 5 most affected provinces", size(small)) 
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("Reference scenario, with confidence limits", size(small))	
...
subtitle("3 scenarios", size(small))	
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("Best scenario, with confidence limits", size(small))	
...
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
subtitle("Worse scenario, with confidence limits", size(small))	
...
qui graph save "graph 21 a COVID-19 daily cases, $country, subnational, IHME, reference scenario.gph", replace
qui graph export "graph 21 a COVID-19 daily cases, $country, subnational, IHME, reference scenario.pdf", replace
...
(line DayCasMeRaA02S01XXX date, sort lwidth(thick) lcolor(gray)) /// 6 "CAN" 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, IHME, reference scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
qui graph save "graph 21 b COVID-19 daily cases, $country, subnational, most affected, IHME, reference scenario.gph", replace
qui graph export "graph 21 b COVID-19 daily cases, $country, subnational, most affected, IHME, reference scenario.pdf", replace
...
qui qui graph save "graph 21 c COVID-19 daily cases, $country, `l', IHME, reference scenario.gph", replace
qui qui graph export "graph 21 c COVID-19 daily cases, $country, `l', IHME, reference scenario.pdf", replace
...
qui qui graph save "graph 22 COVID-19 daily cases, $country, `l', IHME, reference scenario.gph", replace
qui qui graph export "graph 22 COVID-19 daily cases, $country, `l', IHME, reference scenario.pdf", replace
...
qui qui graph save "graph 23 COVID-19 daily cases, $country, `l', IHME, best scenario.gph", replace
qui qui graph export "graph 23 COVID-19 daily cases, $country, `l', IHME, best scenario.pdf", replace
...
qui qui graph save "graph 24 COVID-19 daily cases, $country, `l', IHME, worse scenario.gph", replace
qui qui graph export "graph 24 COVID-19 daily cases, $country, `l', IHME, worse scenario.pdf", replace
...
qui graph save "graph 41 a COVID-19 total cases, $country, subnational, IHME, reference scenario.gph", replace
qui graph export "graph 41 a COVID-19 total cases, $country, subnational, IHME, reference scenario.pdf", replace
...
(line TotCasMeRaA02S01XXX date, sort lwidth(thick) lcolor(gray)) /// 6 "CAN" 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Total cases) title("COVID-19 total cases, $country, IHME, reference scenario", size(medium)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
qui graph save "graph 41 b COVID-19 total cases, $country, subnational, most affected, IHME, reference scenario.gph", replace
qui graph export "graph 41 b COVID-19 total cases, $country, subnational, most affected, IHME, reference scenario.pdf", replace
...
qui qui graph save "graph 41 c COVID-19 total cases, $country, `l', IHME, reference scenario.gph", replace
qui qui graph export "graph 41 c COVID-19 total cases, $country, `l', IHME, reference scenario.pdf", replace
...
qui graph save "graph 51 a COVID-19 daily CFR, $country, subnational, IHME, reference scenario.gph", replace
qui graph export "graph 51 a COVID-19 daily CFR, $country, subnational, IHME, reference scenario.pdf", replace
...
(line DayCfrMeRaA02S01XXX date, sort lwidth(thick) lcolor(gray)) /// 6 "CAN" 
, xtitle(Date) xlabel(#20, format(%tdYY-NN-DD) labsize(small)) xlabel(, grid) xlabel(, grid) ///
xlabel(, angle(forty_five)) ylabel(, format(%9.0fc) labsize(small))  ylabel(, labsize(small) angle(forty_five)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, IHME, reference scenario", size(small)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) legend(region(lcolor(none))) legend(bexpand) ///
...
qui graph save "graph 51 b COVID-19 daily CFR, $country, subnational, most affected, IHME, reference scenario.gph", replace
qui graph export "graph 51 b COVID-19 daily CFR, $country, subnational, most affected, IHME, reference scenario.pdf", replace
...
qui qui graph save "graph 51 c COVID-19 daily CFR, $country, `l', IHME, 3 scenarios.gph", replace
qui qui graph export "graph 51 c COVID-19 daily CFR, $country, `l', IHME, 3 scenarios.pdf", replace
...
subtitle("Estimated only for reference scenario", size(small)) 
...
qui graph save "graph 66 COVID-19 daily new people going to ICU, $country, `l', IHME, reference scenario.gph", replace
qui graph export "graph 66 COVID-19 daily new people going to ICU, $country, `l', IHME, reference scenario.pdf", replace
...
qui graph save "graph 67 COVID-19 total tests, $country, `l', 3 scenarios, IHME.gph", replace
qui graph export "graph 67 COVID-19 total tests, $country, `l', 3 scenarios, IHME.pdf", replace
...
qui graph save "graph 68 COVID-19 daily hospital-related outcomes, $country, `l', reference scenario, IHME.gph", replace
qui graph export "graph 68 COVID-19 daily hospital-related outcomes, $country, `l', reference scenario, IHME.pdf", replace
...
subtitle("Estimated only for reference scenario; without beds needed", size(small)) 

qui graph save "graph 69 COVID-19 daily hospital-related outcomes, $country, `l', reference scenario, IHME, wo beds needed.gph", replace
qui graph export "graph 69 COVID-19 daily hospital-related outcomes, $country, `l', reference scenario, IHME, wo beds needed.pdf", replace
...
qui graph save "graph 76 COVID-19 daily deaths and cases $country, `l', IHME.gph", replace
