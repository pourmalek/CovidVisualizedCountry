...
* This is "do CovidVisualizedCountry master.do"
                                                                                                          *******************
* Project: Combine and visualize international periodically updating                                      * uptake 20211220 *
...
di "$country"                                                                                  // <<<--- *   change country here   *
                                                                                                         ***************************
* To change uptake date, find and replace all, 20211220 (old), with 20211220 (new) <<--           <<<--- * change uptake date here *
                                                                                                         ***************************
...
This file "do CovidVisualizedCountry master.do" was set up to be run from:
  ...
  where 2021MMDD is the udpate date, e.g. update 20211220
...
if regexm(c(os),"Mac") == 1 {
	global pathCovidVisualizedCountry "/Users/`usrnam'/Downloads/CovidVisualizedCountry-main/20211220/code/" 
}
else if regexm(c(os),"Windows") {
	global pathCovidVisualizedCountry = "C:\Users\\`usrnam'\Downloads\CovidVisualizedCountry-main\20211220\code\"
}
*
