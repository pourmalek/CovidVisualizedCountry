...
qui graph save "5DayCasIMPE 6 scenarios - COVID-19 daily cases, 6 scenarios, $country, IMPE.gph", replace
qui graph export "5DayCasIMPE 6 scenarios - COVID-19 daily cases, 6 scenarios, $country, IMPE.pdf", replace




* daily cases, S2 = reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%12.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily cases) title("COVID-19 daily cases, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "6DayCasIMPE reference scenario - COVID-19 daily cases, reference scenario, $country, IMPE.gph", replace
qui graph export "6DayCasIMPE reference scenario - COVID-19 daily cases, reference scenario, $country, IMPE.pdf", replace
...
qui graph save "7TotCasIMPE 6 scenarios - COVID-19 total cases, 6 scenarios, $country, IMPE.gph", replace
qui graph export "7TotCasIMPE 6 scenarios - COVID-19 total cases, 6 scenarios, $country, IMPE.pdf", replace




* total cases, S2 = reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%15.0fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Total cases) title("COVID-19 total cases, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "8TotCasIMPE reference scenario - COVID-19 total cases, reference scenario, $country, IMPE.gph", replace
qui graph export "8TotCasIMPE reference scenario - COVID-19 total cases, reference scenario, $country, IMPE.pdf", replace
...
qui graph save "9DayCfrIMPE 6 scenarios - COVID-19 daily CFR, 6 scenarios, $country, IMPE.gph", replace
qui graph export "9DayCfrIMPE 6 scenarios - COVID-19 daily CFR, 6 scenarios, $country, IMPE.pdf", replace




* daily cfr, S2 = reference scenario 
...
xlabel(, angle(forty_five)) ylabel(, format(%9.2fc) labsize(small))  ylabel(, labsize(small) angle(horizontal)) ///
xscale(lwidth(vthin) lcolor(gray*.2)) yscale(lwidth(vthin) lcolor(gray*.2)) ///
ytitle(Daily CFR) title("COVID-19 daily CFR, $country, IMPE, reference scenario", size(medium)) legend(off)

qui graph save "10DayCfrIMPE reference scenario - COVID-19 daily CFR, reference scenario, $country, IMPE.gph", replace
qui graph export "10DayCfrIMPE reference scenario - COVID-19 daily CFR, reference scenario, $country, IMPE.pdf", replace
...
qui qui graph save "25DayDMuIMPE - COVID-19 daily deaths and cases $country, IMPE.gph", replace
qui qui graph export "25DayDMuIMPE - COVID-19 daily deaths and cases $country, IMPE.pdf", replace
