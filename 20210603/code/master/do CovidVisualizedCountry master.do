...
If the first run does not go thru due to directory path clash, edit the contents within " " of the line _62_ or _65_ below, located beneath ****** set path based on local operating system ****** ,,, 
...
if regexm(c(os),"Mac") == 1 {
	global pathCovidVisualizedCountry "/Users/`usrnam'/Downloads/CovidVisualizedCountry-main/20210603/code/" 
}
else if regexm(c(os),"Windows") {
	global pathCovidVisualizedCountry = "C:\Users\\`usrnam'\Downloads\CovidVisualizedCountry-main\20210603\code\"
}
*
...
CovidVisualizedCountry-main/20210603/output/merge/*.pdf
and CovidVisualizedCountry-main/20210603/output/IMPE/*.pdf
preserve a graphical copy of previously accessed the Imperial College COVID-19 model/study removed updates.

* Data version of previously accessed the Imperial College COVID-19 model/study removed updates are not stored in CovidVisualizedCountry repository 
