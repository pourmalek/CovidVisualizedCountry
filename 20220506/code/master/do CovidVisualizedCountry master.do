...
if regexm(c(os),"Mac") == 1 {
	global pathCovidVisualizedCountry "/Users/`usrnam'/Downloads/CovidVisualizedCountry-main/20220506/code/" 
}
else if regexm(c(os),"Windows") {
	global pathCovidVisualizedCountry = "C:\Users\\`usrnam'\Downloads\CovidVisualizedCountry-main\20220506\code\"
}
*
...
// do "$pathCovidVisualizedCountry/IMPE/do CovidVisualizedCountry IMPE.do" // The latest / last available update of the IMPE model was for 2022-01-31. 
